...
public class KauHActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		web.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				spbr.edit().putString("Browser", "sau_kauH_web").commit();
		...
		apply.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				spbr.edit().putString("Browser", "sau_kauH_apply").commit();
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				i.setClass(getApplicationContext(), BrowserActivity.class);
				startActivity(i);
			}
		...
		check.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				spbr.edit().putString("Browser", "sau_kauH_check").commit();
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				i.setClass(getApplicationContext(), BrowserActivity.class);
				startActivity(i);
			}
	...
	public void onStart() {
		...
		if (sp.getString("Language", "").equals("ar")) {
			textview_heading.setText("جامعة الملك عبدالعزيز (البكالوريوس)");
			...
			textview_heading.setTextSize((float)24);
		...
		if (sp.getString("Language", "").equals("en")) {
			textview_heading.setText("KING ABDULAZIZ UNIVERSITY (GAPOL)");
			...
			apply.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/el_messiri_regular.ttf"), 1);
			check.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/el_messiri_regular.ttf"), 1);
			textview_heading.setTextSize((float)20);
			for(int i = 0; i < _toolbar.getChildCount(); i++){
		...
		if (sp.getString("Language", "").equals("bn")) {
			textview_heading.setText("বাদশাহ আবদুল আজিজ বিশ্ববিদ্যালয় (অনার্স)");

...
public class ImamuActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		web.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				spbr.edit().putString("Browser", "sau_imamu_web").commit();
		...
		apply.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				spbr.edit().putString("Browser", "sau_imamu_apply").commit();
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				i.setClass(getApplicationContext(), BrowserActivity.class);
				startActivity(i);
			}
		...
		check.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				spbr.edit().putString("Browser", "sau_imamu_check").commit();
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				i.setClass(getApplicationContext(), BrowserActivity.class);
				startActivity(i);
			}
	...
	public void onStart() {
		...
		if (sp.getString("Language", "").equals("ar")) {
			textview_heading.setText("جامعة الإمام محمد بن سعود الإسلامية");
			...
			textview_heading.setTextSize((float)23);
		...
		if (sp.getString("Language", "").equals("en")) {
			textview_heading.setText("IMAM MOHAMMAD IBN SAUD\nISLAMIC UNIVERSITY");
		...
		if (sp.getString("Language", "").equals("bn")) {
			textview_heading.setText("ইমাম মুহাম্মাদ ইবনে স‌উদ ইসলামি বিশ্ববিদ্যালয়");

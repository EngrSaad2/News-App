...
public class KauMActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		web.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				spbr.edit().putString("Browser", "sau_kauM_web").commit();
		...
		apply.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				spbr.edit().putString("Browser", "sau_kauM_apply").commit();
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				i.setClass(getApplicationContext(), BrowserActivity.class);
				startActivity(i);
			}
		...
		check.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				spbr.edit().putString("Browser", "sau_kauM_check").commit();
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				i.setClass(getApplicationContext(), BrowserActivity.class);
				startActivity(i);
			}
	...
	public void onStart() {
		...
		if (sp.getString("Language", "").equals("ar")) {
			textview_heading.setText("جامعة الملك عبدالعزيز (المعهد)");
		...
		if (sp.getString("Language", "").equals("en")) {
			textview_heading.setText("KING ABDULAZIZ UNIVERSITY (DCAFL)");
		...
		if (sp.getString("Language", "").equals("bn")) {
			textview_heading.setText("বাদশাহ আবদুল আজিজ বিশ্ববিদ্যালয় (ডিপ্লোমা)");
			...
			textview_heading.setTextSize((float)29);
